  ...
  (
    ...
    return (
      <AccordionPrimitive.Item
        {...props}
        value={value}
        className="relative  w-64 overflow-hidden h-full "
      >
    ...
    return (
      <AccordionPrimitive.Item value={value} className="relative">
        <AccordionPrimitive.Trigger
          ...
          aria-label="File"
          className={cn(
            "flex items-center gap-2 cursor-pointer text-sm pr-1 rtl:pl-1 rtl:pr-0 rounded-md  duration-200 ease-in-out",
            {
